...
- `integration.test.js` — real patterns (`solid_color`, `coordinate_debug`, `lava_flow`, `expanding_rings`, `fire`) against the real egg map; skipped if `~/code/pb/pb_pattern_maker/` isn't present (override with `PB_ROOT`)
